...
from spark.widget.sample import sample_widget_template
from spark.widget.sample import sample_color_variable
from spark.widget.sample import style_sheet_template
...
class SAMPLE_WIDGET(MayaQWidgetDockableMixin, QMainWindow):
